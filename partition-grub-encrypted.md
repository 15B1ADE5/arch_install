...
1. ## Create partitions:
	...
	1. Create the LUKS Boot partition:
		```
		Command (m for help): n
...
1.  Set up Boot partition:
	...
	```
	Note: You can choose any other name instead of `boot`, remember to change this name in other commands addressing `/dev/mapper/<luks-boot-name>`.
